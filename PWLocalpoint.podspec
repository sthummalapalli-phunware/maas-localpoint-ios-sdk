Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '6.0'
  s.source       = { :git => "https://github.com/phunware/maas-localpoint-ios-sdk.git", :tag => 'v2.6.3.2' }
  s.license      = { :type => 'Copyright', :text => 'Copyright 2015 by Phunware Inc. All rights reserved.' }

  s.public_header_files = 'Framework/2.6.3.2/Localpoint.framework/Versions/A/Headers/*.h'
  s.ios.vendored_frameworks = 'Framework/2.6.3.2/Localpoint.framework'
