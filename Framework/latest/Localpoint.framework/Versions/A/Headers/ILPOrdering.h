...
/**
 ...
 @return one of {@link #FIRST_LESS_THAN_SECOND}, {@link #FIRST_EQUAL_TO_SECOND}, or {@link #FIRST_GREATER_THAN_SECOND}, depending on whether the first argument is less than, equal to, or greater than the second argument in this ordering
 */
