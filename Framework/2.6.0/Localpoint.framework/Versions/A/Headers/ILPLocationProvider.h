...
/**
 ...
 @return the location with the given identifier, if such a location is currently known to this provider, or <code>nil</code> otherwise
 */
...
/**
 ...
 @param filter The filter to be applied to the locations to be returned (if <code>nil</code>, acts as a filter that accepts all -- see {@link ILPLocationFilterFactory#getAllFilter()})
