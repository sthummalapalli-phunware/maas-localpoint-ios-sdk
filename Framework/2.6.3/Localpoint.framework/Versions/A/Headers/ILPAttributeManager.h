...
/**
 Define the block which handles the response from locapoint server
 */
 ...
 *
 @param attrs The new profile attributes to be associated with the device. <code>attrs</code> become the complete set of the profile attributes and any existing attributes not in <code>attrs</code> are removed.
 */
...
/**
 ...
 Note: Currently, only one user attribute named "ID1" is supported and its value must be a string. Any other attributes are ignored.

 @param attrs The new user attributes to be associated with the device. <code>attrs</code> become the complete set of the user attributes and any existing attributes not in <code>attrs</code> are removed.
 */
...
/**
 ...
 @param completion The block returns user attribute or error
 */
...
/**
 ...
 @param completion The block returns profile attribute or error
 */
