...
/**
 ...
 @return the message with the given identifier or <code>nil</code>
 */
...
/**
 Delete a message by the given identifier.
 
 @param messageId The identifier of the message to be deleted (must never be <code>nil</code>)
 
 @param completion The block of process result, error is nil if it's deleted successfully.
 */
- (void)deleteMessage:(NSString*)messageId completion:(void(^)(NSError *error))completion;
